/* ----------------------------------------------------------------------------
  ...
  Based on Bosch Sensortec Datasheet and Adafruit algorithms for reading
 ...
 * readCoefficients will read the calibration coefficients to use in temperature
 ...
 --------------------------------------------------------------------------- */
bool BMP280::begin(uint8_t mode, uint8_t osrs_p, uint8_t osrs_t,
...
/* -- Gets Power Mode ---------------------------------------------------------
---------------------------------------------------------------------------- */
uint8_t BMP280::getPowerMode(void) {
 ...
 * sends one of the combinations to BMP280_CTRL_MEAS register bits 4, 3, 2
 --------------------------------------------------------------------------- */
void BMP280::setPressureOverSampling(uint8_t osrs_p) {
...
---------------------------------------------------------------------------- */
uint8_t BMP280::getPressureOverSampling(void){
 ...
 * sends one of the combinations to BMP280_CTRL_MEAS register bits 7, 6, 5
 --------------------------------------------------------------------------- */
void BMP280::setTemperatureOverSampling(uint8_t osrs_t) {
...
---------------------------------------------------------------------------- */
uint8_t BMP280::getTemperatureOverSampling(void){
 ...
 * sends one of the configurations to BMP280_CONFIG register bits 7, 6, 5
 --------------------------------------------------------------------------- */
void BMP280::setStandbyTime(uint8_t t_sb) {
...
/* -- Gets Standby Time -------------------------------------------------------
---------------------------------------------------------------------------- */
uint8_t BMP280::getStandbyTime(void){
 ...
 * sends to BMP280_CONFIG register bits 4, 3, 2
 --------------------------------------------------------------------------- */
void BMP280::setIIRcoeff(uint8_t filter) {
...
---------------------------------------------------------------------------- */
uint8_t BMP280::getIIRcoeff(void){
 ...
 * (invert equation!)
 ---------------------------------------------------------------------------- */
float BMP280::readAltitude(float seaLevel) {
  float altitude;
 ...
 * unsigned
---------------------------------------------------------------------------- */
void BMP280::write8(byte reg, byte data) {
